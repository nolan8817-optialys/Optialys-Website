    ...
    <div className="pt-32 pb-20">
      ...
      <section className="py-24 px-6 relative overflow-hidden">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-4xl font-bold text-white mb-4">{T.stepsTitle}</h2>
            <p className="text-xl text-brand-gray">{T.stepsSub}</p>
          </div>
                ...
                <div className={`relative flex flex-col md:flex-row gap-8 md:gap-16 items-start ${i % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  <div className="w-full md:w-1/2">
                    <div className="p-8 rounded-2xl bg-brand-card/50 border border-brand-blue/10 h-full">
                      <h4 className="text-white font-bold mb-6">{T.whatYouGet}</h4>
          ...
          <FadeIn>
            <div className="p-10 md:p-16 rounded-3xl bg-brand-navy border-2 border-brand-blue relative shadow-[0_0_50px_rgba(0,194,255,0.15)] overflow-hidden">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white">{T.guaranteeTitle}</h2>
              </div>
      ...
      <section className="py-24 px-6 bg-brand-navy-2 border-y border-brand-blue/10">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">{T.examplesTitle}</h2>
            <p className="text-xl text-brand-gray">{T.examplesSub}</p>
          </div>
              ...
              <FadeIn key={i} delay={i * 0.1}>
                <div className="p-8 rounded-2xl bg-brand-card/50 border border-brand-blue/20 backdrop-blur-sm h-full flex flex-col group hover:border-brand-blue/50 transition-colors">
                  ...
                  <div className="space-y-6 flex-1">
                    <div>
                      <div className="text-xs font-bold text-brand-gray uppercase mb-2">{T.situation}</div>
                      <p className="text-white font-medium">{ex.situation}</p>
                    </div>
                    <div>
                      <div className="text-xs font-bold text-brand-gray uppercase mb-2">{T.automation}</div>
                      <p className="text-brand-gray text-sm leading-relaxed">{ex.automation}</p>
                    </div>
                  </div>

                  <div className="mt-8 pt-6 border-t border-brand-blue/10">
                    <div className="text-xs font-bold text-brand-gray uppercase mb-2">{T.typicalResult}</div>
          ...
          <div className="mt-12 text-center">
            <p className="text-brand-gray whitespace-pre-line">
              {T.examplesFooter}
            </p>
          </div>
        </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white">{T.proofTitle}</h2>
          </div>
