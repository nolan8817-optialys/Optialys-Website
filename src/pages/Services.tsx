    ...
    <div className="pt-32 pb-20 bg-bg-cream">
      <section className="px-6 max-w-4xl mx-auto mb-24">
        ...
        >
          ...
          <h1 className="text-2xl md:text-xl font-serif font-normal text-ink-navy mb-6">
      ...
      <section className="mt-32 py-24 bg-surface-white border-y border-border-cream">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <FadeIn>
            <h2 className="text-xl font-serif font-normal text-ink-navy mb-4">{t('services.stack.title')}</h2>
      ...
      <section className="py-24 px-6 text-center">
        <FadeIn>
          <h2 className="text-xl font-serif font-normal text-ink-navy mb-8">{t('services.cta.book')}</h2>
