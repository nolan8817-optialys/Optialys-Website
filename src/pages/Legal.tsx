...
export const Legal = () => {
  ...
  const T = fr ? {
    ...
    s5t: "5. Cookies",
    s5p1: "The Site may ask you to accept cookies for statistical and display purposes. A cookie is information placed on your hard drive by the server of the site you are visiting.",
      ...
      <section className="px-6 max-w-4xl mx-auto">
        <FadeIn direction="up">
          <div className="p-8 md:p-12 rounded-3xl bg-brand-card/30 border border-brand-blue/10 space-y-12">
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">{T.s1t}</h2>
              <div className="text-brand-gray space-y-2 leading-relaxed">
                <p>{T.s1p1}</p>
                <p className="font-bold text-white mt-4">Optialys</p>
                <p>{T.s1p2}</p>
                <p>{T.s1email} <a href="mailto:nolan@optialys.com" className="text-brand-blue hover:underline">nolan@optialys.com</a></p>
              </div>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-white mb-4">{T.s2t}</h2>
              <div className="text-brand-gray space-y-2 leading-relaxed">
                <p>{T.s2p1}</p>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">{T.s3t}</h2>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">{T.s4t}</h2>
              <div className="text-brand-gray space-y-4 leading-relaxed">
                <p>{T.s4p1}</p>
                <p>{T.s4p2}</p>
                <p>
                  {T.s4p3a} <a href="mailto:nolan@optialys.com" className="text-brand-blue hover:underline">nolan@optialys.com</a>.
                </p>
              </div>
            </div>

            <div>
              <h2 className="text-2xl font-bold text-white mb-4">{T.s5t}</h2>
              <div className="text-brand-gray space-y-4 leading-relaxed">
                <p>{T.s5p1}</p>
                <p>{T.s5p2}</p>
              </div>
            ...
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">{T.s6t}</h2>
              <div className="text-brand-gray space-y-4 leading-relaxed">
                <p>{T.s6p1}</p>
                <p>{T.s6p2}</p>
              </div>
