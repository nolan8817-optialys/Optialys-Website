  ...
  return (
    <div className="pt-32 pb-20 bg-bg-cream">
      ...
      <section className="px-6 max-w-4xl mx-auto mb-24">
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-ink-navy mb-6 leading-[1.08]">
        ...
        <a href={CALENDLY} target="_blank" rel="noopener noreferrer">
          <GlowButton variant="primary" className="text-base px-7 py-4">
            {fr ? 'Réserver un Diagnostic — 500 €' : 'Book a Diagnostic — €500'} <ArrowRight className="w-5 h-5" />
          </GlowButton>
        </a>
      </section>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-ink-navy mb-10">
      ...
      <section className="py-24 px-6 bg-surface-white border-y border-border-cream">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-ink-navy mb-12">
      ...
      <section className="py-24 px-6">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-ink-navy mb-12">FAQ</h2>
      ...
      <section className="py-28 px-6 bg-bg-cream">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-ink-navy mb-6">
