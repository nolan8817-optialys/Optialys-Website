...
export const About = () => {
  ...
  const T = {
    ...
    subtitle: fr ? "Nous construisons les systèmes IA qui permettent aux agences immobilières et PME françaises de passer à l'échelle sans exploser leurs coûts." : "We build the AI systems that allow French real estate agencies and SMEs to scale without exploding their costs.",
    role: fr ? "Fondateur & Consultant en automatisation IA" : "Founder & AI Automation Consultant",
    badge1: "🇫🇷 Nice, France",
    badge2: "SKEMA Business School",
    badge3: "Expert n8n",
    p1: fr ? "J'ai 19 ans, j'étudie au Global BBA de SKEMA Business School — et depuis 2 ans et demi, je travaille comme consultant indépendant, aidant des agences immobilières et PME à construire leur infrastructure opérationnelle avec des outils comme Airtable et n8n." : "I'm 19 years old, studying for a Global BBA at SKEMA Business School — and for the past 2.5 years, I've been working as an independent consultant, helping real estate agencies and SMEs build operational infrastructure using tools like Airtable and n8n.",
    p2: fr ? "Au fil des projets, j'ai remarqué quelque chose qui change tout : chaque infrastructure que je construisais pouvait être 10× plus puissante avec les bonnes automatisations connectées dessus. J'ai donc passé ces 2 ans et demi à apprendre l'IA et l'automatisation — pas en théorie, mais en déployant des systèmes réels pour des entreprises réelles." : "Along the way, I noticed something that changed everything: every infrastructure I built could be 10x more powerful with the right automations connected to it. So I spent those 2.5 years learning AI and automation — not in theory, but by deploying real systems for real businesses.",
    p3: fr ? "Travailler avec des agences immobilières, des sociétés comme Koosmik, OmniTrust, Global IT Services PSF et LybraMedia m'a appris l'essentiel : la plupart des agences ne manquent pas d'outils — elles manquent de quelqu'un qui sait les connecter correctement à leur réalité métier." : "Working with real estate agencies and companies like Koosmik, OmniTrust, Global IT Services PSF and LybraMedia taught me something essential: most agencies don't lack the tools — they lack someone who knows how to connect them properly to their business reality.",
    ...
    missionD: fr ? "Démocratiser l'accès aux technologies d'automatisation avancées pour les agences immobilières et PME françaises, transformant l'IA en avantage compétitif tangible et mesurable." : "Democratize access to advanced automation technologies for French real estate agencies and SMEs, transforming AI into a tangible and measurable competitive advantage.",
