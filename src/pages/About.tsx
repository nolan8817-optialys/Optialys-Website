      ...
      <section className="px-6 max-w-6xl mx-auto space-y-32">
        <FadeIn direction="up">
          <div className="flex flex-col md:flex-row gap-12 md:gap-16 items-start">
            <div className="w-full md:w-5/12 flex justify-center md:justify-start shrink-0">
              <div className="relative rounded-[12px] overflow-hidden shadow-[0_0_40px_rgba(0,194,255,0.15)] max-w-sm w-full">
                <img
            ...
            <div className="w-full md:w-7/12 flex flex-col">
              <div className="mb-8">
                ...
                <p className="text-xl font-medium text-brand-blue mb-4">{T.role}</p>
                <div className="flex flex-wrap gap-2 text-sm font-bold text-brand-gray">
                  <span className="px-3 py-1 rounded-full bg-brand-blue/10 border border-brand-blue/20">{T.badge1}</span>
                  <span className="px-3 py-1 rounded-full bg-brand-blue/10 border border-brand-blue/20">{T.badge2}</span>
                  <span className="px-3 py-1 rounded-full bg-brand-blue/10 border border-brand-blue/20">{T.badge3}</span>
                </div>
              </div>
        ...
        <FadeIn direction="up">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-white">{T.dna}</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-brand-card/50 border border-brand-blue/10 text-center">
              ...
              <h3 className="text-xl font-bold text-white mb-4">{T.missionT}</h3>
              <p className="text-brand-gray leading-relaxed">{T.missionD}</p>
            </div>
            <div className="p-8 rounded-2xl bg-brand-card/50 border border-brand-blue/10 text-center">
              <Lightbulb className="w-12 h-12 text-brand-blue mx-auto mb-6" />
              <h3 className="text-xl font-bold text-white mb-4">{T.approachT}</h3>
              <p className="text-brand-gray leading-relaxed">{T.approachD}</p>
            </div>
            <div className="p-8 rounded-2xl bg-brand-card/50 border border-brand-blue/10 text-center">
              <ShieldCheck className="w-12 h-12 text-brand-blue mx-auto mb-6" />
              <h3 className="text-xl font-bold text-white mb-4">{T.valuesT}</h3>
              <p className="text-brand-gray leading-relaxed">{T.valuesD}</p>
            </div>
          </div>
        </FadeIn>
      </section>
