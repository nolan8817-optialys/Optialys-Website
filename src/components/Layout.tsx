...
const Navbar = () => {
  ...
  const navLinks = [
    ...
    { name: 'Optialys Core™', path: '/optialys-core' },
    { name: 'Optialys Partner', path: '/optialys-partner' },
  ...
  return (
    <footer className="bg-brand-navy border-t border-brand-blue/10 pt-20 pb-10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          >
            ...
            <p className="text-brand-gray text-sm">
              Operational. Intelligent. Custom-built for your SME.
            </p>
          ...
          >
            ...
            <ul className="space-y-3 text-sm text-brand-gray">
              ...
              <li><Link to="/optialys-core" className="hover:text-brand-blue transition-colors">Optialys Core™</Link></li>
              <li><Link to="/case-studies" className="hover:text-brand-blue transition-colors">Case Studies</Link></li>
          ...
          >
            ...
            <ul className="space-y-3 text-sm text-brand-gray">
              <li><Link to="/diagnostic" className="hover:text-brand-blue transition-colors">AI Audit & Diagnostic (Free)</Link></li>
              <li><Link to="/roi-calculator" className="hover:text-brand-blue transition-colors">ROI Calculator</Link></li>
              <li><Link to="/optialys-core" className="hover:text-brand-blue transition-colors">Optialys Core™</Link></li>
              <li><Link to="/services" className="hover:text-brand-blue transition-colors">Maintenance & Optimization</Link></li>
              <li><Link to="/services" className="hover:text-brand-blue transition-colors">Custom Development</Link></li>
            </ul>
          </motion.div>
          ...
          >
            ...
            <ul className="space-y-3 text-sm text-brand-gray">
              <li><Link to="/legal" className="hover:text-brand-blue transition-colors">Legal Notice</Link></li>
              <li><Link to="/legal" className="hover:text-brand-blue transition-colors">Privacy Policy</Link></li>
            </ul>
          </motion.div>
        </div>
        ...
        >
          © {new Date().getFullYear()} Optialys — AI Automation for European SMEs
        </motion.div>
      </div>
    </footer>
  );
